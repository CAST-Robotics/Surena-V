...
left_hand::left_hand(VectorXd q_ra, VectorXd r_target, MatrixXd R_target)
{
...
left_hand::left_hand(VectorXd q_ra, VectorXd v, VectorXd r_target, MatrixXd R_target)
{
    HO_FK_left_palm(q_ra);
    dist = distance(r_target, r_left_palm);
    sai_target = sai_calc(R_target);
...
left_hand::left_hand(VectorXd q_ra, VectorXd r_target, MatrixXd R_target, double d0, double v_0, double v__target)
{
    HO_FK_left_palm(q_ra);
    dist = distance(r_target, r_left_palm);
    sai_target = sai_calc(R_target);
...
void left_hand::update_left_hand(VectorXd q_ra, VectorXd v, VectorXd r_target, MatrixXd R_target)
{
    HO_FK_left_palm(q_ra);
    dist = distance(r_target, r_left_palm);
    sai_target = sai_calc(R_target);
...
// void left_hand::matrix_view(VectorXd M){
//     QString str;
...
void left_hand::HO_FK_left_palm(VectorXd q_ra)
{
    ...
    // FK formula
    T_left_palm = R1_fix_shd * R1_ra * R2_fix_shd * R2_ra * R3_ra * P_arm_ra * R1_fix_elbow * R4_ra * R5_ra * P_forearm_ra * R2_fix_elbow * R6_ra * R7_ra * P_palm_ra;
...
void left_hand::euler2w()
{
    ...
    // w_left_palm<<cos(phi)*theta_dot + sin(phi)*sin(theta)*sai_dot,
    //         sin(phi)*theta_dot - cos(phi)*sin(theta)*sai_dot,
    //         cos(theta)*sai_dot + phi_dot;
    // w_left_palm=-w_left_palm;
    //  main
    ...
    // cout<<w_left_palm(0)<<','<<w_left_palm(1)<<','<<w_left_palm(2)<<endl;
}
// wrist IK
...
double left_hand::move2pose(double max, double t_local, double T_start, double T_end)
{
...
void left_hand::SendGazebo(vector<double> q)
{
    ros::NodeHandle nh;
...
void left_hand::jacob(VectorXd q_ra)
{
    ...
    J_w_left_palm << 0, cos(q_ra(0)), cos(angle_fix_shd + q_ra(1)) * sin(q_ra(0)), -cos(angle_fix_elbow) * (cos(q_ra(0)) * sin(q_ra(2)) - cos(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))) - sin(angle_fix_elbow) * (cos(q_ra(0)) * cos(q_ra(2)) + sin(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))), cos(q_ra(3)) * (cos(angle_fix_shd) * cos(q_ra(1)) * sin(q_ra(0)) - sin(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1))) + sin(q_ra(3)) * (cos(angle_fix_elbow) * (cos(q_ra(0)) * cos(q_ra(2)) + sin(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))) - sin(angle_fix_elbow) * (cos(q_ra(0)) * sin(q_ra(2)) - cos(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0))))), -cos(q_ra(4)) * (sin(angle_fix_elbow) * (cos(angle_fix_elbow) * (cos(q_ra(0)) * sin(q_ra(2)) - cos(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))) + sin(angle_fix_elbow) * (cos(q_ra(0)) * cos(q_ra(2)) + sin(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0))))) + cos(angle_fix_elbow) * (sin(q_ra(3)) * (cos(angle_fix_shd) * cos(q_ra(1)) * sin(q_ra(0)) - sin(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1))) - cos(q_ra(3)) * (cos(angle_fix_elbow) * (cos(q_ra(0)) * cos(q_ra(2)) + sin(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))) - sin(angle_fix_elbow) * (cos(q_ra(0)) * sin(q_ra(2)) - cos(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0))))))) - sin(q_ra(4)) * (cos(angle_fix_elbow) * (cos(angle_fix_elbow) * (cos(q_ra(0)) * sin(q_ra(2)) - cos(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))) + sin(angle_fix_elbow) * (cos(q_ra(0)) * cos(q_ra(2)) + sin(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0))))) - sin(angle_fix_elbow) * (sin(q_ra(3)) * (cos(angle_fix_shd) * cos(q_ra(1)) * sin(q_ra(0)) - sin(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1))) - cos(q_ra(3)) * (cos(angle_fix_elbow) * (cos(q_ra(0)) * cos(q_ra(2)) + sin(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))) - sin(angle_fix_elbow) * (cos(q_ra(0)) * sin(q_ra(2)) - cos(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0))))))), sin(q_ra(5)) * (cos(q_ra(3)) * (cos(angle_fix_shd) * cos(q_ra(1)) * sin(q_ra(0)) - sin(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1))) + sin(q_ra(3)) * (cos(angle_fix_elbow) * (cos(q_ra(0)) * cos(q_ra(2)) + sin(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))) - sin(angle_fix_elbow) * (cos(q_ra(0)) * sin(q_ra(2)) - cos(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))))) - cos(q_ra(5)) * (cos(q_ra(4)) * (cos(angle_fix_elbow) * (cos(angle_fix_elbow) * (cos(q_ra(0)) * sin(q_ra(2)) - cos(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))) + sin(angle_fix_elbow) * (cos(q_ra(0)) * cos(q_ra(2)) + sin(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0))))) - sin(angle_fix_elbow) * (sin(q_ra(3)) * (cos(angle_fix_shd) * cos(q_ra(1)) * sin(q_ra(0)) - sin(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1))) - cos(q_ra(3)) * (cos(angle_fix_elbow) * (cos(q_ra(0)) * cos(q_ra(2)) + sin(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))) - sin(angle_fix_elbow) * (cos(q_ra(0)) * sin(q_ra(2)) - cos(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0))))))) - sin(q_ra(4)) * (sin(angle_fix_elbow) * (cos(angle_fix_elbow) * (cos(q_ra(0)) * sin(q_ra(2)) - cos(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))) + sin(angle_fix_elbow) * (cos(q_ra(0)) * cos(q_ra(2)) + sin(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0))))) + cos(angle_fix_elbow) * (sin(q_ra(3)) * (cos(angle_fix_shd) * cos(q_ra(1)) * sin(q_ra(0)) - sin(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1))) - cos(q_ra(3)) * (cos(angle_fix_elbow) * (cos(q_ra(0)) * cos(q_ra(2)) + sin(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))) - sin(angle_fix_elbow) * (cos(q_ra(0)) * sin(q_ra(2)) - cos(q_ra(2)) * (cos(angle_fix_shd) * sin(q_ra(0)) * sin(q_ra(1)) + cos(q_ra(1)) * sin(angle_fix_shd) * sin(q_ra(0)))))))),
...
void left_hand::doQP(VectorXd q_ra)
{
    ...
    if (q_next(0) < toRad(minimum[0]) - .005)
    {
        q_next(0) = toRad(minimum[0]);
        cout << "qr" << 1 << " out of range!";
    }
    if (q_next(0) > toRad(maximum[0]) + .005)
    {
        q_next(0) = toRad(maximum[0]);
        cout << "qr" << 1 << " out of range!";
    }
    if (q_next(1) < toRad(minimum[1]) - .005)
    {
        q_next(1) = toRad(minimum[1]);
        cout << "qr" << 2 << " out of range!";
    }
    if (q_next(1) > toRad(maximum[1]) + .005)
    {
        q_next(1) = toRad(maximum[1]);
        cout << "qr" << 2 << " out of range!";
    }
    if (q_next(2) < toRad(minimum[2]) - .005)
    {
        q_next(2) = toRad(minimum[2]);
        cout << "qr" << 3 << " out of range!";
    }
    if (q_next(2) > toRad(maximum[2]) + .005)
    {
        q_next(2) = toRad(maximum[2]);
        cout << "qr" << 3 << " out of range!";
    }
    if (q_next(3) < toRad(minimum[3]) - .005)
    {
        q_next(3) = toRad(minimum[3]);
        cout << "qr" << 4 << " out of range!";
    }
    if (q_next(3) > toRad(maximum[3]) + .005)
    {
        q_next(3) = toRad(maximum[3]);
        cout << "qr" << 4 << " out of range!";
    }
    if (q_next(4) < toRad(minimum[4]) - .005)
    {
        q_next(4) = toRad(minimum[4]);
        cout << "qr" << 5 << " out of range!";
    }
    if (q_next(4) > toRad(maximum[4]) + .005)
    {
        q_next(4) = toRad(maximum[4]);
        cout << "qr" << 5 << " out of range!";
    }
    if (q_next(5) < toRad(minimum[5]) - .005)
    {
        q_next(5) = toRad(minimum[5]);
        cout << "qr" << 6 << " out of range!";
    }
    if (q_next(5) > toRad(maximum[5]) + .005)
    {
        q_next(5) = toRad(maximum[5]);
        cout << "qr" << 6 << " out of range!";
    }
    if (q_next(6) < toRad(minimum[6]) - .005)
    {
        q_next(6) = toRad(minimum[6]);
        cout << "qr" << 7 << " out of range!";
    }
    if (q_next(6) > toRad(maximum[6]) + .005)
    {
        q_next(6) = toRad(maximum[6]);
        cout << "qr" << 7 << " out of range!";
    }
}
...
vector<int> left_hand::data2qc(vector<double> cntrl)
{
    ...
    for (int i = 0; i < 12; ++i)
    {
        if (qref[i] < minimumQC[i])
        {
            qref[i] = minimumQC[i];
        }
        if (qref[i] > maximumQC[i])
        {
            qref[i] = maximumQC[i];
        }
    }
