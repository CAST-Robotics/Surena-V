...
void object_detect(const hand_planner::DetectionInfoArray & msg){
    for(int i=0; i < msg.detections.size(); i ++)
    {
        if (msg.detections[i].class_id == 110){ // && msg.detections[0].distance != 0
...
int main(int argc, char **argv) 
{
    ...
    ofstream testYaw;
    testYaw.open("/home/surenav/DynCont/Code/WalkTest/src/hand_planner/src/testYaw.txt", std::ofstream::out);
    ofstream testPitch;
    testPitch.open("/home/surenav/DynCont/Code/WalkTest/src/hand_planner/src/testPitch.txt", std::ofstream::out);
