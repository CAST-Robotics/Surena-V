...
#include "../Eigen/Geometry" // a C++ libary useful for robotics
#include "../Eigen/QuadProg.h" // allow to use the QuadProg QP solver with the Eigen3 library
#include "../Eigen/testQPsolvers.hpp" // This library offers tools and implementations to write, specialize and test QP solvers
#include "../Eigen/eiquadprog.hpp" // allow to use the QuadProg QP solver with the Eigen3 
#include "../Eigen/Core" // This is the main module of Eigen providing dense matrix and vector support (both fixed and dynamic size)
#include "../Eigen/Cholesky" // This module provides two variants of the Cholesky decomposition for selfadjoint (hermitian) matrices
#include "../Eigen/LU" // This module includes LU decomposition and related notions such as matrix inversion and determinant.
// Eigen is a C++ template library for linear algebra: matrices, vectors, numerical solvers, and related algorithms.
#include<math.h> // a header file in the standard library of the C programming language designed for basic mathematical operations.
#include <iostream>
#include <vector>
#include "fstream"
#include <string>
