...
using namespace  Eigen;
   ...
   if(time_r<t_r(1)&& time_r>=t_r(0)){
    ...
    // sine motion for elbow (q(3)) joint
    q_ra(3)=q_ra(3)-0.125*M_PI/180*cos((time_r-t_r(2))*(M_PI));
    ...
    q[6]=q_ra(6);
     ...
     ofstream fw("/home/cast/Projects/pybullet/shakehands5.txt", std::ofstream::out);
...
*/
// g++ shakehands.cpp S5mod_right_hand.cpp MinimumJerkInterpolation.cpp