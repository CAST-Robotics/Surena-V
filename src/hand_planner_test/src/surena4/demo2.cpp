...
using namespace  Eigen;
    ...
    r_target2_r<<.35,-0.05,0.25; //
    r_midpoint2_r<<.3, -0.15,-0.15;
    R_target2_r=hand_funcs.rot(2,-180*M_PI/180,3)*hand_funcs.rot(3,90*M_PI/180,3);
...
*/
                ...
                if(time_rr<t_r(1)&& time_rr>=t_r(0)){
                        P_r<<   coef_generator.GetAccVelPos(X_coef_r.row(0),time_rr,t_r(0),5)(0,0),
                                coef_generator.GetAccVelPos(Y_coef_r.row(0),time_rr,t_r(0),5)(0,0),
                                coef_generator.GetAccVelPos(Z_coef_r.row(0),time_rr,t_r(0),5)(0,0);
                        V_r<<   coef_generator.GetAccVelPos(X_coef_r.row(0),time_rr,t_r(0),5)(0,1),
                                coef_generator.GetAccVelPos(Y_coef_r.row(0),time_rr,t_r(0),5)(0,1),
                                coef_generator.GetAccVelPos(Z_coef_r.row(0),time_rr,t_r(0),5)(0,1);
                ...
                else if(time_rr<t_r(2)&& time_rr>=t_r(1)){
                        P_r<<   coef_generator.GetAccVelPos(X_coef_r.row(1),time_rr,t_r(1),5)(0,0),
                                coef_generator.GetAccVelPos(Y_coef_r.row(1),time_rr,t_r(1),5)(0,0),
                                coef_generator.GetAccVelPos(Z_coef_r.row(1),time_rr,t_r(1),5)(0,0);
                        V_r<<   coef_generator.GetAccVelPos(X_coef_r.row(1),time_rr,t_r(1),5)(0,1),
                                coef_generator.GetAccVelPos(Y_coef_r.row(1),time_rr,t_r(1),5)(0,1),
                                coef_generator.GetAccVelPos(Z_coef_r.row(1),time_rr,t_r(1),5)(0,1);
        ...
        {
            //cout<<"entered"<<":  "<<time_r;
            q_ra(2)=q_ra(2)-0.5*M_PI/180*cos((time_r-8)*(2*M_PI));
...
//bool midpoint=true;
     ...
     ofstream fw("/home/cast/Projects/pybullet/demo2.txt", std::ofstream::out);
...
*/
//g++ demo2.cpp MinimumJerkInterpolation.cpp S5mod_right_hand.cpp